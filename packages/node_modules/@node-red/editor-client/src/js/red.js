...
var RED = (function() {
    ...
    function completeLoad() {
        ...
        script.src = "https://rawgit.com/iamdanfox/anno.js/gh-pages/dist/anno.js";
        $("head").append(script);

        var plugin = document.createElement("script");
        plugin.type = "text/javascript";
        plugin.src = "https://cdnjs.cloudflare.com/ajax/libs/jquery-scrollintoview/1.8/jquery.scrollintoview.js";
        $("head").append(plugin);

        var style = document.createElement("link");
        style.rel = "stylesheet";
        style.href = "https://rawgit.com/iamdanfox/anno.js/gh-pages/dist/anno.css";
        style.type = "text/css";
        $("head").append(style);
        ...
        var style = document.createElement("link");
        style.rel = "stylesheet";
        style.href = "https://unpkg.com/intro.js/minified/introjs.min.css";
        style.type = "text/css";
        $("head").append(style);
        */
        ...
        var script = document.createElement("script");
        script.type = "text/javascript";
        script.src = "https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tour/0.12.0/js/bootstrap-tour-standalone.min.js";
        $("head").append(script);

        var style = document.createElement("link");
        style.rel = "stylesheet";
        style.href = "https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tour/0.12.0/css/bootstrap-tour-standalone.min.css";
        style.type = "text/css";
        $("head").append(style);
        */
    ...
    function startTour() {
        var anno1 = new Anno([{
            target: '#red-ui-palette-search',
            content: 'Start by dragging some elements onto the workspace.',
            buttons: [AnnoButton.NextButton]
            },{
            target : '#red-ui-workspace-chart',
            position: 'center',
            content: 'Connect elements to create a workflow.'
            },{
            target : '#red-ui-header-button-deploy',
            position: 'center-bottom',
            content: 'Click to run your workflow.'
            }])
        anno1.show();
        ...
        introJs().setOptions({
            steps: [{
              intro: "Welcome to Encanto²!"
            }, {
              element: document.querySelector('#red-ui-header-button-deploy'),
        ...
        */
        ...
        var tour = new Tour({
            steps: [
            {
            element: "#red-ui-header-logo",
            title: "Inject some data",
            content: "Select a node to inject some data into your flow"
            }
        ]});
